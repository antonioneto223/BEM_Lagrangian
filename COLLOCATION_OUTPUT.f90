	SUBROUTINE COLLOCATION_OUTPUT(STEP)
!
...
!
	IMPLICIT NONE 
!
	INTEGER::STEP,I,J,K,II,JJ,KK,L,NEN,C,N_CRACKED_ELEM,nnum,nnodes
!
...
!------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	OPEN(90,file='LIXO',status='unknown')
		WRITE(90,500)'Output_data\COLLOCATION_OUTPUT',STEP,'.ogl'
	CLOSE(90)
!	
...
!
	...
	WRITE(3,10)
	DO I=1,N_COLLOCPOINTS
	    WRITE(3,200)COORD_COLLOCPOINTS(I,1),COORD_COLLOCPOINTS(I,2),COORD_COLLOCPOINTS(I,3),U(3*I-2),U(3*I-1),U(3*I)
	ENDDO
	WRITE(3,*)
	...
	DO I=1,N_ELEM
	    IF(CRACKED_ELEM(I).EQ."UNCRACKED")THEN	
            ...
            CASE(4)
                WRITE(3,'(8x,i1,7x,i1,7x,i5,7x,i5,7x,i5,7x,2i5)')3,1,COLLOCPOINTS_CONNECTIVITY(I,1),COLLOCPOINTS_CONNECTIVITY(I,2),COLLOCPOINTS_CONNECTIVITY(I,4),COLLOCPOINTS_CONNECTIVITY(I,3),ND(I)
            CASE(8)
	...
	WRITE(3,*)'Ux'
	DO I=1,N_COLLOCPOINTS
	    WRITE(3,400)U(3*I-2),U(3*I-1),U(3*I),U(3*I-2)    
	ENDDO
	WRITE(3,*)
	...
	WRITE(3,*)'Uy'
	DO I=1,N_COLLOCPOINTS
	    WRITE(3,400)U(3*I-2),U(3*I-1),U(3*I),U(3*I-1)    
	ENDDO	
	WRITE(3,*)
	...
	WRITE(3,*)'Uz'
	DO I=1,N_COLLOCPOINTS
	    WRITE(3,400)U(3*I-2),U(3*I-1),U(3*I),U(3*I)    
	ENDDO	
	WRITE(3,*)
	...
	WRITE(3,*)'Tx'
	DO I=1,N_COLLOCPOINTS
	    WRITE(3,400)U(3*I-2),U(3*I-1),U(3*I),T(3*I-2)    
	ENDDO
	WRITE(3,*)
	...
	WRITE(3,*)'Ty'
	DO I=1,N_COLLOCPOINTS
	    WRITE(3,400)U(3*I-2),U(3*I-1),U(3*I),T(3*I-1)    
	ENDDO
	WRITE(3,*)
	...
	WRITE(3,*)'Tz'
	DO I=1,N_COLLOCPOINTS
	    WRITE(3,400)U(3*I-2),U(3*I-1),U(3*I),T(3*I)    
	ENDDO
!	
	CLOSE(3)
    
    OPEN(90,file='LIXO',status='unknown')
		WRITE(90,500)'Output_data\Paraview\COLLOCATION_OUTPUT',STEP,'.vtk'
	CLOSE(90)
	OPEN(90,file='LIXO',status='OLD')
		READ(90,*)NOME
	CLOSE(90, STATUS = 'DELETE')
...
!
    ...
    WRITE(3,'(a)')'Animation data'
    WRITE(3,'(a)')'ASCII'
    WRITE(3,'(a)')
    WRITE(3,'(a)')'DATASET UNSTRUCTURED_GRID'
    nnodes=N_COLLOCPOINTS
    WRITE(3,'(a,1x,i0,1x,a)')'POINTS ',nnodes,' float'
	DO I=1,N_COLLOCPOINTS
	    WRITE(3,'(3(f0.10,1x))')COORD_COLLOCPOINTS(I,1),COORD_COLLOCPOINTS(I,2),COORD_COLLOCPOINTS(I,3)
    ENDDO
    ...
    DO J=1,N_ELEM
        ...
        NNUM = NNUM + NEN +1
    ENDDO  
    WRITE(3,'(a,1x,i0,1x,i0)')'CELLS ',N_ELEM,nnum
    DO I=1,N_ELEM
	    IF(CRACKED_ELEM(I).EQ."UNCRACKED")THEN	
	        NEN=ELEM_TYPE(I)*ORDER_ELEM(I)+(ELEM_TYPE(I)-3)*(ORDER_ELEM(I)-1)*POL_FAMILY(I)
            WRITE(3,'(100(I0,1X))')NEN,(COLLOCPOINTS_CONNECTIVITY(I,J)-1,J=1,NEN)
        ENDIF
    ENDDO
    
    WRITE(3,'(a,1x,i0)')'CELL_TYPES ',N_ELEM
    DO I=1,N_ELEM
        IF(CRACKED_ELEM(I).EQ."UNCRACKED")THEN	
            NEN=ELEM_TYPE(I)*ORDER_ELEM(I)+(ELEM_TYPE(I)-3)*(ORDER_ELEM(I)-1)*POL_FAMILY(I)
            SELECT CASE(NEN)
            ...
            CASE (4,9)
                WRITE(3,'(I0)') 70
            CASE (8)
                WRITE(3,'(I0)') 23  ! NAO VALIDADO
            END SELECT
        ENDIF
    ENDDO
    
    WRITE(3,'(a,1x,i0)')'POINT_DATA ',nnodes
    WRITE(3,'(a,1x,i0)')'SCALARS DISPLACEMENT FLOAT ',3
    WRITE(3,'(a)')'LOOKUP_TABLE default'
	DO I=1,N_COLLOCPOINTS
	    WRITE(3,'(4(f0.10,1x))')U(3*I-2),U(3*I-1),U(3*I)   
    ENDDO
    
    WRITE(3,'(a,1x,i0)')'SCALARS TRACTIONS FLOAT ',3
    WRITE(3,'(a)')'LOOKUP_TABLE default'
	DO I=1,N_COLLOCPOINTS
	    WRITE(3,'(3(f0.10,1x))')T(3*I-2),T(3*I-1),T(3*I)   
    ENDDO
!	
	CLOSE(3)
