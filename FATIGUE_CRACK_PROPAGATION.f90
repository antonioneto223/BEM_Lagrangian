	SUBROUTINE FATIGUE_CRACK_PROPAGATION
!	
...
!    
    REAL*8::GTHETA,GTHETA_AUX,THETA,E,Nu,Dmin,Dmin_AUX,A1,A2,A1_AUX,A2_AUX,DX,DY,DZ,R,F
...
!                     CRACK_INCREMENT(CONT)=MAX_CRACKINCREMENT*((Keq(CONT)/Keqmax)**FFMP(ND(ELEMENT),3))
                     CRACK_INCREMENT(CONT)=MAX_CRACKINCREMENT*((Keq(CONT)/Keqmax)**1.D0)
                 ELSE
!                     CRACK_INCREMENT(CONT)=MAX_CRACKINCREMENT*(0.05D0**FFMP(ND(ELEMENT),3))
                     CRACK_INCREMENT(CONT)=MAX_CRACKINCREMENT*(0.05D0**1.D0)
                 ENDIF                
            ENDIF
        ENDIF
    ENDDO
...
! 
    DEALLOCATE(COORD_CRACKTIP,KI,KII,KIII,COD,CSD,CTD,THETAP,PHIP,Keq,Gmax,CRACK_INCREMENT,VERTICAL_INCREMENT,CRACKTIP_COLLOCPOINTS,COORD_INTPOINTS,NDI)
!            	    
    END SUBROUTINE FATIGUE_CRACK_PROPAGATION
