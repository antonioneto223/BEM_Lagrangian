...
!
    ALLOCATE(CRACKED_EDGES(N_ELEM,2),CRACKED_ELEM(N_ELEM),COORD_INTERCEPTPOINTS(N_ELEM,4,3),&
        COORD_EXTRAINTERCEPTPOINTS(N_ELEM,3),COORD_BOUNDARYCRACKTIP(N_ELEM,3),NEW_ELEMENTS(N_ELEM,3),&
        COORD_BOUNDARYCRACKTIPSTOP(N_ELEM,2,3),CHANGEABLE_ELEM(N_ELEM),CHANGEABLE_COLLOCPOINTS(N_COLLOCPOINTS))
    CRACKED_EDGES=0  
    NEW_ELEMENTS=0  
