	SUBROUTINE FATIGUE_OUTPUT(STEP)
!
...
!
	OPEN(90,file='LIXO',status='unknown')
		WRITE(90,500)'COLLOCATION_OUTPUT',STEP,'.ogl'
	CLOSE(90)
!	
...
300	FORMAT(8x,i1,7x,i1,7x,i4,7x,i4,7X,i4)
301	FORMAT(8x,i1,7x,i1,7x,i4,7x,i4,7x,i4,7x,i4,7x,i4,7x,i4)
302	FORMAT(8x,i1,7x,i1,7x,i4,7x,i4,7x,i4,7x,i4)
303	FORMAT(8x,i1,7x,i1,7x,i4,7x,i4,7x,i4,7x,i4,7x,i4,7x,i4,7x,i4,7x,i4)
304	FORMAT(8x,i1,7x,i1,7x,i4,7x,i4,7x,i4,7x,i4,7x,i4,7x,i4,7x,i4,7x,i4,7x,i4)
